...
const ThemeToggle = () => {
  ...
  // this gets resolved with a few clicks around but is a bit annoying

  //Bug has to do with which icons are set to "swap-on" and "swap-off", but need to update which has which class in the correct order or it messes up :<
